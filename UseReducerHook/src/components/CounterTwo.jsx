  ...
  return (
    <>
      <div className='m-10 flex flex-col items-center'>
        ...
        <span className='m-2'>{state.secondCounter}</span>
        <div className="flex">
          <button className='p-2 w-16 border-2 border-black-600 bg-green-500 rounded' onClick={()=>dispatch({type: 'Increment2', value:5})}>+5</button>
          <button className='p-2 w-16 border-2 border-black-600 bg-red-500 rounded' onClick={()=>dispatch({type: 'Decrement2', value:5})}>-5</button>
          <button className='p-2 w-16 border-2 border-black-600 bg-orange-500 rounded' onClick={()=>dispatch({type: 'Reset2'})}>Reset</button>
        </div>
      </div>
    </>
  )
