...
const Footer = () => {
  return (
    <>
      <div className="container footerStyle">
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top " style={{width: '100vw'}}>
