...
const PostListProvider =({children}) =>{
  ...
  const addPostAPI =(postsapi) =>{
    // console.log(postsapi)
    dispatchPostList({type: 'ADD_POST_API', payload: postsapi })
  }
  ...
  return(
    <PostList.Provider value={{postList, addPost, deletePost, addPostAPI}} >{children}</PostList.Provider>
  )
}
